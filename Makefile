...
ifndef VERSION
	...
	$(SED_I) "s/version: \"[0-9].[0-9][0-9]*\.[0-9][0-9]*\"/version: \"$(VERSION)\"/g" docs/ci-cd/reference
	$(SED_I) "s/version = \"v[0-9].[0-9][0-9]*\.[0-9][0-9]*\"/version = \"v$(VERSION)\"/g" docs/other/bazel.md
