        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        "bsr/managed-packages/overview",
                        "bsr/managed-packages/npm-registry",
                        "bsr/managed-packages/go",
                        "bsr/managed-packages/migrating-from-alpha",
                    ],
                    customProps: {
                        badge: {
                            label: "beta",
