...
you're done &mdash; no handwritten marshaling, routing, or client code
required!
...
* You'll need one of the [last two major releases][go-releases] of Go, with a
  minimum of Go 1.18. See Go's [Getting Started][install-go] guide for
...
- The new [Connect protocol](../protocol.md), a simple, POST-only protocol that
