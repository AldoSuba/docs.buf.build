...
file is often used with a [module](../../bsr/overview.md#modules) (or another
...
valid [module names](../../bsr/overview.md#modules).
...
This setting is used for [workspace](../../reference/workspaces.md)
