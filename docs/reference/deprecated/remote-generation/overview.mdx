...
stubs from [Buf modules](../../../bsr/overview.mdx#modules) that you've pushed to the BSR.
...
Plugins belong to an [owner](../../../bsr/user-management.md#owner) and may be public or
...
Templates belong to an [owner](../../../bsr/user-management.md#owner) and can be public or
...
[CI/CD pipeline](../../../ci-cd/setup.mdx).
