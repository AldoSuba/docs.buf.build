...
[remote packages](../../../bsr/remote-packages/explanation) and
[remote plugins](../../../bsr/remote-plugins/explanation).

For existing users, please see the
[remote packages migrating from alpha](../../../bsr/remote-packages/how-to)
and
[remote plugins migrating from alpha](../../../bsr/remote-plugins/how-to)
...
stubs from [Buf modules](../../../bsr/explanation#modules) that you've pushed
...
Plugins belong to an [owner](../../../bsr/user-management/explanation#owner) and may be
...
[remote plugins](../../../bsr/remote-plugins/how-to).
...
Templates belong to an [owner](../../../bsr/user-management/explanation#owner) and can be
...
[module](../../../bsr/explanation#modules) versions into a
...
[Go packages](/bsr/remote-packages/reference/go) but will be expanded to
other languages.
...
recommend performing [breaking change detection](/buf/breaking/how-to)
_before_ pushing a new version of a Buf module, potentially as part of your
[CI/CD pipeline](../../../ci-cd/reference#checks).
