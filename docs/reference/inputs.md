...
`buf` commands. In most cases, this is a [module](../bsr/overview.md#modules),
...
The core primitive for Buf is the [module](/bsr/overview.md#modules). Protobuf
on its own has **no concept of modules**, only files. The Buf Schema Registry
([BSR](../bsr/overview.md)) is a registry for Buf modules that you want to
