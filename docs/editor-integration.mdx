...
[build](/buf/build/usage), [lint](/buf/lint/overview), and
[breaking change](/buf/breaking/overview) errors which integrate with IDEs, scripts,
and other tools.
...
as part of your [CI](/buf/ci-cd/setup) process.
