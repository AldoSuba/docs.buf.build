...
Registry and its APIs, create a repository and push a module with generated documentation. Most of all you'll
familiarise yourself with Dependency Management, powered by the BSR, solving one of the greatest challenges of the
protobuf ecosystem. In the end, you will put it all together to build an API client with Remote Packages.
...
> The pushed module will create a tag, this is included in the CLI output. Your value will differ.
