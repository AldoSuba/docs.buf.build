---
id: how-to
title: "Mastering Buf Breaking Change Detection: A Step-by-Step Guide"
...
[input](../other/inputs) to compare it against. In the above example, you
...
> [GitHub Actions](../../ci-cd/reference) to seamlessly add breaking change
...
[SSH Authentication](../other/inputs#ssh) for more details.
