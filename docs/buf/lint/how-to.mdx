---
id: how-to
title: "Mastering Buf Lint: A Guide to Writing Clean Protocol Buffers"
...
[Buf module](../../bsr/explanation.mdx#modules) by adding a
...
[`DEFAULT`](./reference/rules#default) rules.
...
so you can target the [input](../other/inputs) defined in the current
...
`buf` can lint [inputs](../other/inputs) beyond your local Protobuf
files, such as [Git repositories](../other/inputs#git) and
[tarballs](../other/inputs#tar). This can be useful in a variety of
...
[HTTPS Authentication](../other/inputs#https) and
[SSH Authentication](../other/inputs#ssh).
