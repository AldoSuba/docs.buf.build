...
[module](../bsr/overview.md#modules) you pushed to the [BSR](../bsr/overview.md)
to implement a gRPC client and server in Go. That's a great start, but product
requirements always evolve and new features need to be built over time.

In this section, you'll incorporate another dependency into your
`PetStoreService` API and use a [workspace](../reference/workspaces.md) to
