...
> The [remote code generation](/reference/deprecated/remote-generation/overview) feature is
...
one of the BSR's
[hosted templates](/reference/deprecated/remote-generation/overview.mdx#hosted-templates).
...
The [Go module path](../reference/deprecated/remote-generation/overview.mdx#the-go-module-path)
...
- The Protobuf module
- The [template](/reference/deprecated/remote-generation/overview.mdx#hosted-templates) version
...
<Syntax
  ...
  segments={[
    ...
    { separator: "." },
    {
      ...
      kind: "variable",
      href: "/reference/deprecated/remote-generation/overview#templates"
    },
    { separator: "." },
    {
      label: "commitSequenceID",
      kind: "variable",
      href: "/reference/deprecated/remote-generation/overview#commits"
    }
  ]}
/>
