...
<Tabs defaultValue="download" values={[ {label: 'Download from a release',
value: 'download'}, {label: 'Build from source', value: 'build'}, ]}>
...
If you wish to authenticate a CI/CD job to access the [BSR](../bsr/overview.md)
...
[Module Cache docs](../bsr/overview.md#module-cache).
