---
id: how-to
title: "Setting up Buf on GitHub Actions: A Step-by-Step Guide"
description: "Automating Buf Workflows with GitHub Actions: A Setup and Configuration Guide"
---

> If you are using [GitHub Actions](https://github.com/features/actions), you
> can skip this guide and refer to the [GitHub Actions guide](reference)
> instead.
...
skip this guide and refer to the [GitHub Actions guide](reference)
instead.
...
If your [`buf.yaml`](../configuration/v1/buf-gen-yaml.md) is defined at the root of
...
[breaking change detector](../buf/breaking/explanation).

## CI authentication (Optional)

If you wish to authenticate a CI/CD job to access the [BSR](../bsr/explanation)
...
[Authentication](../bsr/authentication/reference).
...
[Module Cache docs](../bsr/explanation#module-cache).
