...
We have made improvements to remote code generation, this section has been replaced with new [NPM registry][npm-registry-documentation] documentation.

For existing users, please see the [migration guide][migration-guide] and if you run into issues contact us on [Buf Public Slack][buf-slack-link].
...
[migration-guide]: ./migration-guide.md#bsr-npm-registry
[npm]: https://npmjs.org
[npm-config]: https://docs.npmjs.com/cli/v8/commands/npm-config#set
[npm-registry-documentation]: /bsr/generated-assets/npm-registry
