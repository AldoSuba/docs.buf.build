...
id: overview
title: Overview
description: "Take your Buf Schema Registry workflow to the next level with remote packages - Explore the benefits and use cases of remote packages and learn how to incorporate them into your projects today."
---
