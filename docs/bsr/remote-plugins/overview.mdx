...
id: overview
title: Overview
description: "Extend the power of Buf Schema Registry with remote plugins - Discover how to leverage remote plugins to enhance your Protobuf-based projects and unlock new capabilities."
---
